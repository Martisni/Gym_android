package com.svalero.gym.adapters;
...
import com.svalero.gym.R;
import com.svalero.gym.RutinaDetailsActivity;
...
public class RutinaAdapter extends RecyclerView.Adapter<RutinaAdapter.RutinaViewHolder> {
    ...
    @Override
    public RutinaAdapter.RutinaViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(RutinaAdapter.RutinaViewHolder holder, int position) {
