...
import com.svalero.gym.UsuarioDetailsActivity;
...
public class PerfilAdapter extends RecyclerView.Adapter<PerfilAdapter.PerfilViewHolder> {
    ...
    public PerfilAdapter.PerfilViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        return new PerfilAdapter.PerfilViewHolder(view);
    }

    @Override
    public void onBindViewHolder(PerfilAdapter.PerfilViewHolder holder, int position) {
