...
import com.svalero.gym.adapters.UsuarioAdapter;
import com.svalero.gym.database.AppDatabase;
import com.svalero.gym.domain.LanguageItem;
...
public class ViewUsuarioActivity extends AppCompatActivity {
    ...
    protected void onResume(){
        ...
        final AppDatabase database = Room.databaseBuilder(this, AppDatabase.class, "usuario")
                .allowMainThreadQueries().build();
        usuarioList.clear();
        usuarioList.addAll(database.usuarioDao().getAll());
